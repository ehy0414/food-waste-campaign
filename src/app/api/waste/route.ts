...
//   console.log(`요청된 날짜: ${disYear}-${disMonthStr}`);
  ...
  // API 요청 URL 생성
  const url = `https://apis.data.go.kr/B552584/RfidFoodWasteServiceNew/getTotalDateList?serviceKey=${API_KEY}&type=json&disYear=${disYear}&disMonth=${disMonthStr}&page=1&rowNum=30`;
